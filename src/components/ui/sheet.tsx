...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ...
    } as React.ComponentPropsWithoutRef<typeof SheetPrimitive.Overlay>)}
  />
))
  ...
  <SheetPortal>
    ...
    >
      <SheetPrimitive.Close
        ...
        } as React.ComponentPropsWithoutRef<typeof SheetPrimitive.Close>)}
      />
      {children}
    </SheetPrimitive.Content>
  </SheetPortal>
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ...
    } as React.ComponentPropsWithoutRef<typeof SheetPrimitive.Title>)}
  />
))
